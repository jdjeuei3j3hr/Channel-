...
GROUP_ID = "-1002428694270"
CHANNEL_USERNAME = "@MUSTAFALEAKS2"
...
def handle_attack(message):
    ...
    full_command = f"./Moin {target} {port} {time_duration} 1000"
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝐘𝐨𝐮 𝐌𝐔𝐒𝐓 𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐈𝐑𝐒𝐓!**\n"
                                  f"🔗 **𝐉𝐨𝐢𝐧 𝐇𝐞𝐫𝐞:** [Click Here](https://t.me/MUSTAFALEAKS2")
            return  
...
👉 [𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙂𝙧𝙤𝙪𝙥](https://t.me/mustafaxddos) 🚀🔥"""
